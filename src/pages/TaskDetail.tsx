...
const TaskDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-6">
      <button
        onClick={() => navigate('/tasks')}
        className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-sm text-muted-foreground shadow-sm transition-colors hover:border-primary/40 hover:text-foreground"
      >
        <ArrowLeft className="h-4 w-4" />
        Back to Tasks
      </button>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <div className="min-w-0 space-y-6">
          {/* Task Header */}
          <div className="overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-background via-card to-emerald-50/40 p-6 shadow-sm sm:p-8">
            <div className="mb-6 flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted-foreground">
                  {(task as any).project_name || task.project?.name || 'No project'}
                </p>
                <h1 className="mt-2 break-words text-3xl font-semibold leading-tight tracking-tight text-foreground sm:text-4xl">
                  {task.title}
                </h1>
              </div>
              {(canEdit || canDelete) && (
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-border/60 bg-background/80 p-4 shadow-sm">
                ...
                <p className="mt-2 text-sm font-semibold capitalize">{task.priority}</p>
              </div>
              <div className="rounded-2xl border border-border/60 bg-background/80 p-4 shadow-sm">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Comments</p>
                <p className="mt-2 text-sm font-semibold">{comments.length}</p>
              </div>
            </div>

            <div className="mt-6 rounded-2xl border border-border/60 bg-background/80 p-5 shadow-sm">
          ...
          <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-sm">
            <div className="flex items-center gap-3 border-b border-border/60 bg-muted/30 p-4 sm:p-5">
