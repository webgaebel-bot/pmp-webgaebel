...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { key: 'dashboard.projects.view', name: 'dashboard.projects.view', module: 'dashboard', description: 'View project snapshot widgets' },
  { key: 'dashboard.leads.view', name: 'dashboard.leads.view', module: 'dashboard', description: 'View lead snapshot widgets' },
  { key: 'dashboard.finance.view', name: 'dashboard.finance.view', module: 'dashboard', description: 'View finance snapshot widgets' },
...
const PERMISSION_ALIASES: Record<string, string[]> = {
  ...
  'dashboard.projects.view': ['dashboard.view'],
  'dashboard.leads.view': ['dashboard.view'],
  'dashboard.finance.view': ['dashboard.view'],
  'sales.dashboard.view': ['sales.view', 'dashboard.view', 'leads.view', 'time.view'],
  'sales.view': ['dashboard.view', 'leads.view', 'time.view'],
